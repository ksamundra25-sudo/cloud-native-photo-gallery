...
randomBtn?.addEventListener("click", () => {
  const r1 = randomHex();
  const r2 = randomHex();
  document.documentElement.style.setProperty("--accent", r1);
  document.documentElement.style.setProperty("--accent2", r2);
  localStorage.setItem("accentColor", r1);
  localStorage.setItem("accentColor2", r2);

  const p1 = document.getElementById("accentPicker");
  const p2 = document.getElementById("accentPicker2");
  if(p1) p1.value = r1;
  if(p2) p2.value = r2;
});
